...
<body>
  ...
  <?php if ($_GET['type'] === 'user'): ?>
    ...
    <form action="" method="post">
      ...
      <p>ユーザー名</br><input type="text" name="name" value="<?php echo h($app->getValues()->user->name); ?>" required></p>
      <p>管理者フラグ</br>
        <select name="admin">
      ...
      <p>自己紹介</br><textarea class="fs24" name="description" rows="6"><?php echo h($app->getValues()->user->description); ?></textarea></p>
      <p>メールアドレス</br><input type="text" name="email" value="<?php echo h($app->getValues()->user->email); ?>" required></p>
  ...
  <?php if ($_GET['type'] === 'article'): ?>
    ...
    <form action="" method="post">
      ...
      <p>自己紹介</br><textarea class="fs24" name="description" rows="6"><?php echo h($app->getValues()->article->description); ?></textarea></p>
